...
export default function DocNav() {
  ...
  const { routeNameMap, section, setSection } = useSideRoute('docs');
  ...
  return (
    <nav
      className={cn(
        'lg:pl-5 lg:pr-5 h-16 sticky top-0 items-center w-full flex justify-between bg-wash dark:bg-wash-dark pt-0 z-50',
        !isOpen && 'shadow'
      )}>
      <div className="xl:w-full xl:max-w-xs flex items-center">
        ...
        <NextLink href="/ant-s">
          <a className="inline-flex text-l items-center text-primary dark:text-primary-dark py-1 mr-0 sm:mr-3 whitespace-nowrap">
            <ImageX src={'/favicon.ico'} height={20} width={20} />
      ...
      <div className="lg:flex items-center hidden max-w-2xl">
        ...
        <div className="w-80 pl-10 lg:flex">
        ...
        <div className="block ml-5 dark:hidden">
          <button
            type="button"
        ...
        <div className="hidden ml-5 dark:block">
          <button
            type="button"
